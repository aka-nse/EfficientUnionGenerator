...
public partial class EfficientUnionGenerator : IIncrementalGenerator
{
    ...
    private static UnionTypeDefinition Predicate(GeneratorAttributeSyntaxContext context, CancellationToken token)
    {
    ...
    private static void Emit(SourceProductionContext context, UnionTypeDefinition source)
    {
