...
public partial class Generator : IIncrementalGenerator
{
    ...
    private static UnitTypeGenerationInfo? PredicateUnionType(GeneratorAttributeSyntaxContext context, CancellationToken token)
    {
...
file class Comparer : IEqualityComparer<UnitTypeGenerationInfo?>
{
