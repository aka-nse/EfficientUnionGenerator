...
public partial class Generator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        var sourceUnion = context.SyntaxProvider.ForAttributeWithMetadataName(
                ...
                PredicateUnionType)
            .WithComparer(UnionTypeDefinitionEqualityComparer.Instance);
    ...
    public static bool IsEfficientUnionAttribute(AttributeData attrData) =>
        attrData.AttributeClass?.ToDisplayString() == EfficientUnionAttributeFullName;


    public static (TypeIdentifierValueMode mode, ulong bitMask) ReadAttributeParameter(AttributeData attrData)
    {
